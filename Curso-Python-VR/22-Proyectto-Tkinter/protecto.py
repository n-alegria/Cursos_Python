...
def add():
    # Configuro y muestro la pantalla
    add_label.config(
        fg="white",
        bg="black",
        font=("Arial", 30),
    ...
    # Ocultar las otras pantallas para que no se superpongan
...
def add_products():
    ...
    # Elimino los datos de las entradas luego de ingresar datos
    name_data.set("")
    price_data.set("")
...
data_label = Label(ventana, text="Creado por Lautaro Alegria")
